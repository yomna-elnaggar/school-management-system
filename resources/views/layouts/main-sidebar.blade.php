                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard">
                            <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">@lang("main_sied.Dashboard")</span>
                            </div>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">@lang("main_sied.grades")</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url("dashboard/grades")}}">@lang("main_sied.list-grades")</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#calendar-menu">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">@lang("main_sied.classroom")</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="calendar-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url("dashboard/classroom")}}">@lang("classroom.List_classes") </a> </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#sections">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">@lang("main_sied.section")</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="sections" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url("dashboard/section")}}">@lang("main_sied.section-list")</a></li>
                      ...
                      <!-- menu item chat-->
                        ...
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#teacher">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">@lang("main_sied.teacher")</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="teacher" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url("dashboard/teachers")}}">@lang("main_sied.teacher-list")</a></li>
                    ...
                    <!-- menu item chat-->
                     <!-- menu item chat-->
                        ...
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#students">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">@lang("main_sied.students")</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="students" class="collapse" data-parent="#sidebarnav">
                           <li><a href="{{url("dashboard/students")}}">@lang("main_sied.students-list")</a></li> 
                            <li><a href="{{url("dashboard/students/create")}}">@lang("main_sied.add_student")</a></li>

                            <li>
                                <a href="javascript:void(0);" data-toggle="collapse" data-target="#Students_upgrade">{{trans('main_sied.promotions_Students')}}<div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div></a>
                                <ul id="Students_upgrade" class="collapse">
                                    <li> <a href="{{url("dashboard/students/promotions")}}">@lang("main_sied.add_Promotion")</a></li>
                                    <li> <a href="{{url("dashboard/students/promotions_manage")}}">@lang("main_sied.promotions_Students_manege")</a> </li>
                                </ul>
                            </li>

                            <li>
                                <a href="javascript:void(0);" data-toggle="collapse" data-target="#Graduate students">{{trans('main_sied.Graduate_students')}}<div class="pull-right"><i class="ti-plus"></i></div><div class="clearfix"></div></a>
                                <ul id="Graduate students" class="collapse">
                                    <li> <a href="{{url("students/graduation/create")}}">{{trans('main_sied.add_Graduate')}}</a> </li>
                                    <li> <a href="{{url("students/graduation")}}">{{trans('main_sied.list_Graduate')}}</a> </li>
                                </ul>
                            </li>
                    ...
                    <!-- menu item chat-->
                        ...
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#parents">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">@lang("main_sied.Parents")</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="parents" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{url("dashboard/show-parent")}}">@lang("main_sied.Parents-list")</a></li>
                            <li><a href="{{url("dashboard/add-parent")}}">@lang("main_sied.AddParents")</a></li>
                        </ul>
                    </li>
                     <!-- Accounts-->
                     <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Accounts-menu">
                            <div class="pull-left"><i class="fas fa-money-bill-wave-alt"></i><span
                                    class="right-nav-text">{{trans('main_sied.Accounts')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{url("students/Fees")}}">الرسوم الدراسية</a> </li>

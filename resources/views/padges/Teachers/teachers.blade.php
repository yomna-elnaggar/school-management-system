            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <div class="col-xl-12 mb-30">
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{url("dashboard/teachers/create")}}" class="btn btn-success btn-sm" role="button"
                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($Teachers as $Teacher)
                                            ...
                                            <td>{{$Teacher->specialization->name}}</td>
                                                <td>
                                                    <a href="{{url("dashboard/teachers/{$Teacher->id}/edit")}}" " class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                            ...
                                            <div class="modal fade" id="delete_Teacher{{$Teacher->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{url("dashboard/teachers/delete")}}" method="post">
                                                       @csrf
